...
DeviceBitHttpClient::DeviceBitHttpClient(const char * user_key, const char * gateway)
{
    char *ptr = head;
    int head_length = 0;
    int tmp;
    ...
    // build Host.
    tmp = sprintf(ptr, "Host: open.devicebit.com \r\n");
    head_length += tmp;
    ptr += tmp;

    // build User-Agent.
    tmp = sprintf(ptr, "User-Agent: Arduino\r\n");
    head_length += tmp;
    ptr += tmp;
...
int DeviceBitHttpClient::append(const char * name, int value)
{
    int length;
    int tmp;
    char * ptr;
...
int DeviceBitHttpClient::append(const char * name, double value)
{
    int length;
    int tmp;
    char * ptr;
